...
<div class="image-with-caption alignright" style="width:150px"><div class="caption">Mangatar</div><a href="http://jfoucher.com/uploads/2009/06/mangatar2big.png"><img src="http://jfoucher.com/uploads/2009/06/mangatar2big-150x150.png" alt="Mangatar" title="Mangatar" width="150" height="150" class="size-thumbnail wp-image-77" /></a></div>The solution is easy if you're using Firefox as your browser. I made use of the zoom feature to zoom in on the flash where the avatar creation occurs, and as flash does not lose resoution as you zoom in on it, you just have to print your screen when you are at the size you want and voilà! your high(er) res mangatar!
