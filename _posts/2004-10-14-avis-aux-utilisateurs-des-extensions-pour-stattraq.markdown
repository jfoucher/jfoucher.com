...
Mais la variable <code lang="php" inline="true">$p</code> n'existe que si le billet est sélectionné par son id. S'il a été selectionné par nom, <code lang="php" inline="true">$p</code> est nul.
